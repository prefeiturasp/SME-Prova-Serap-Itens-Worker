...
{
    public class ObterAreaConhecimentoQueryHandler : IRequestHandler<ObterAreaConhecimentoQuery, IEnumerable<AreaConhecimentoDto>>
    {
        private readonly IServicoClientApi servicoClientApi;
        private readonly IServicoLog servicoLog;

        public ObterAreaConhecimentoQueryHandler(IServicoClientApi servicoClientApi, IServicoLog servicoLog)
        {
            this.servicoClientApi = servicoClientApi ?? throw new ArgumentNullException(nameof(servicoClientApi));
            this.servicoLog = servicoLog ?? throw new ArgumentNullException(nameof(servicoLog));
        }

        public async Task<IEnumerable<AreaConhecimentoDto>> Handle(ObterAreaConhecimentoQuery request, CancellationToken cancellationToken)
        {
            try
            {
