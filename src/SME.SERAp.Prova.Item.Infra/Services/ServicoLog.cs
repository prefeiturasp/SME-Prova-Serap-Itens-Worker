...
namespace SME.SERAp.Prova.Item.Infra.Services
{
    public class ServicoLog : IServicoLog
    {
        ...
        {
            public LogMensagem(string mensagem, LogNivel nivel, string observacao, string rastreamento = null, string excecaoInterna = null, string projeto = "SME_SERAp_Prova_Item_Worker")
            {
                Mensagem = mensagem;
                Nivel = nivel;
